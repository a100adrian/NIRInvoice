...
$(document).ready(function () {
    ...
    $('table > tbody  > tr[id="stock_list"]').each(function(index, tr) {
        maxIndex = index;
    });
    $collectionHolder.find('.add_form').each(function (index) {
        addFormUserView(index);
        $('#add_single_product'+index).click(function (e) {
            addForm(index);
        });
    });
